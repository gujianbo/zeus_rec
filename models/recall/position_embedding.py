...
def _make_positional_encoding(d_model, positional_encoding, max_len):
    """
    ...
    if positional_encoding is None:
        ...
        return FixedPositionalEncoding(d_model, max_len=max_len)
    elif positional_encoding == "learned":
        return LearnedPositionalEncoding(d_model, max_len=max_len)
    else:
        raise ValueError("Invalid positional encoding type: {}".format(positional_encoding))
