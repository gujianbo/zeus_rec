...
from position_embedding import _make_positional_encoding
...
def make_transformer(N=6, d_ff=2048, h=8, dropout=0.1, n_features=136, positional_encoding="learned", position_len=128):
    """
    ...
    position = _make_positional_encoding(n_features, positional_encoding, position_len)
